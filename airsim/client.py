...
#basic flight control
    def setApiControlTimeout(self, timeout_sec, vehicle_name = ''):
        """
        Set timeout in seconds for API control. If no API command is received within this time, 
        vehicle will hover or land.
        """
        self.client.call('setApiControlTimeout', timeout_sec, vehicle_name)
